...
1. **Distillation: Why a 7B student can beat a 70B teacher on narrow tasks**
   - File: `part-4-training-adaptation/module-17-peft/section-17.5.html`
...
2. **Quantization: Why 0.1% of activations decide the whole model's fate (outliers)**
   - File: `part-2-understanding-llms/module-09-inference-optimization/section-9.2.html`
...
3. **MoE: Why sparse activation works at all**
   - File: `part-2-understanding-llms/module-07-modern-llm-landscape/section-7.3.html`
...
6. **Cross-encoder reranking: Why a tiny reranker beats a bigger embedding model**
   - File: `part-7-retrieval-information-extraction-with-llms/module-35-advanced-rag/section-35.1.html`
   - After Figure 35.2.4 (bi-encoder vs cross-encoder)
...
8. **CoT distillation: Why small students inherit reasoning by imitating tokens**
   - File: `part-4-training-adaptation/module-17-peft/section-17.6.html`
   - After Section 17.6.3 discussion of CoT format flexibility
...
9. **Matryoshka embeddings: Why you get five embedding sizes for free**
   - File: `part-7-retrieval-information-extraction-with-llms/module-31-embeddings-vector-db/section-31.2.html`
   - After Figure 31.2.3 (Matryoshka diagram)
...
- **DPO (`section-18.3.html`)**: Multiple strong key-insights including "DPO's β does two jobs", "DPO Offline Assumption", "Why DPO Doesn't Need a Reward Model", "A/B Taste Test" mental model. No additions needed.
...
- **Quantization NF4 (`section-9.1.html`)**: Key insights on NF4 distribution-awareness and BF16 dynamic range already crisp.
- **Speculative decoding (`section-9.4.html`)**: P vs NP analogy and editor metaphor already excellent.
- **Model merging (`section-17.7.html`)**: Cocktail mixer and linear-mode-connectivity insights are strong.
- **RLVR (`section-18.6.html`)**: Multiple key insights about auto-graded math exam mental model.
...
## Files Modified
1. `part-4-training-adaptation/module-17-peft/section-17.5.html`
2. `part-4-training-adaptation/module-17-peft/section-17.6.html`
3. `part-2-understanding-llms/module-09-inference-optimization/section-9.2.html`
4. `part-2-understanding-llms/module-07-modern-llm-landscape/section-7.3.html`
5. `part-5-multimodal-llms/module-22-vision-language-models/section-22.2.html`
6. `part-7-retrieval-information-extraction-with-llms/module-31-embeddings-vector-db/section-31.3.html`
7. `part-7-retrieval-information-extraction-with-llms/module-31-embeddings-vector-db/section-31.2.html`
8. `part-7-retrieval-information-extraction-with-llms/module-35-advanced-rag/section-35.1.html`
