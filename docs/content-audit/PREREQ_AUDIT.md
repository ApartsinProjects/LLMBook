...
| part-9-llm-evaluation-observability/module-42-evaluation-foundations/section-42.7.html | ../../part-9-llm-evaluation-observability/module-44-online-e | Section 44.6 | prereq points FORWARD: target is at (9, 44, 4406), this section is at (9, 42, 42 |
| part-9-llm-evaluation-observability/module-42-evaluation-foundations/section-42.9.html | ../module-44-online-eval-observability/section-44.4.html | Section 44.4 | prereq points FORWARD: target is at (9, 44, 4404), this section is at (9, 42, 42 |
| part-9-llm-evaluation-observability/module-42-evaluation-foundations/section-42.9.html | ../module-44-online-eval-observability/section-44.6.html | Section 44.6 | prereq points FORWARD: target is at (9, 44, 4406), this section is at (9, 42, 42 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.2.html | ../../part-13-llmops-lifecycle/module-66-reliability-slos-re | model registry workflow | prereq points FORWARD: target is at (13, 66, 6602), this section is at (9, 44, 4 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.3.html | ../../part-13-llmops-lifecycle/module-66-reliability-slos-re | model registry workflow | prereq points FORWARD: target is at (13, 66, 6602), this section is at (9, 44, 4 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.4.html | ../../part-14-designing-llm-agent-products/module-70-shippin | Section 70.1 | prereq points FORWARD: target is at (14, 70, 7001), this section is at (9, 44, 4 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.4.html | ../../part-13-llmops-lifecycle/module-62-production-engineer | production engineering | prereq points FORWARD: target is at (13, 62, 0), this section is at (9, 44, 4404 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.6.html | ../../part-13-llmops-lifecycle/module-66-reliability-slos-re | model registry workflows | prereq points FORWARD: target is at (13, 66, 6602), this section is at (9, 44, 4 |
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.7.html | ../module-45-tools-of-the-trade/section-45.2.html | Section 45.2 | prereq points FORWARD: target is at (9, 45, 4502), this section is at (9, 44, 44 |

## Stale Title (78 findings)
...
| part-9-llm-evaluation-observability/module-44-online-eval-observability/section-44.6.html | ../../part-3-working-with-llms/module-11-llm-apis/section-11 | LLM API patterns | link text and target h1 share no significant words |
| part-9-llm-evaluation-observability/module-46-llm-as-judge-automated-evaluation/section-46.2.html | ../../part-1-llm-building-blocks/module-04-decoding-text-gen | decoding and logprob outputs | link text and target h1 share no significant words |
| part-9-llm-evaluation-observability/module-46-llm-as-judge-automated-evaluation/section-46.4.html | ../../part-4-training-adaptation/module-18-alignment-rlhf-dp | DPO and preference-pair training | link text and target h1 share no significant words |

## No Prereq Block (70 findings)
