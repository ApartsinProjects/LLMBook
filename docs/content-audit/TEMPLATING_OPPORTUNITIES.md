...
| **Footer text** | All footers say "Fifteenth Edition, 2026 · Contents". Currently a literal string everywhere; could be templated. | `p1_section_page_layout` already checks for footer |
