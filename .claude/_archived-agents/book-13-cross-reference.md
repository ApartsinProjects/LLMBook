---
name: book-13-cross-reference
description: "Book agent: You build the internal link structure that turns the book into a connected learning system. You do not just report missi"
