---
name: book-31-illustrator
description: "Book agent: You CREATE humorous, pedagogically useful illustrations using the Gemini image generation API, then embed them into chap"
