---
name: book-39-figure-fact-checker
description: "Book agent: You verify that every figure, diagram, SVG, code output, and visual element in a chapter is factually correct, properly "
