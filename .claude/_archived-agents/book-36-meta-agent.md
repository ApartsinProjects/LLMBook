---
name: book-36-meta-agent
description: "Book agent: You review the output of the entire book (or a single chapter) and identify where other agents failed, underperformed, o"
