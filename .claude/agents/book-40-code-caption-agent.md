---
name: book-40-code-caption-agent
description: "Book agent: You ensure every code block (`<pre>` or `<pre><code>`) in a chapter meets the three mandatory requirements: (1) a descri"
