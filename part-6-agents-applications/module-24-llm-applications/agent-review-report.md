...
**Date**: 2026-03-26
**Scope**: index.html, section-24.1 through section-24.7
...
- Section 24.7 is marked advanced, appropriate given the robotics/embodied AI content
...
- Each section follows a clean focus pattern. Section 24.6 is the exception, covering three domains. This is acceptable for a survey chapter.
...
### Visual Inventory
- Section 24.1: 2 SVG diagrams (FIM, agentic loop)
- Section 24.2: 2 SVG diagrams (signal pipeline, regulatory landscape)
- Section 24.3: 1 SVG diagram (clinical NLP pipeline)
- Section 24.4: 1 SVG diagram (LLM search architecture)
- Section 24.5: 2 SVG diagrams (SOC workflow, offensive/defensive)
- Section 24.6: 1 SVG diagram (legal AI workflow)
- Section 24.7: 2 SVG diagrams (SayCan, scientific discovery)
...
- Section 24.6 covering 3 domains (education, legal, creative) could be split, but the current grouping is defensible as "consumer-facing" applications
...
- Section 24.1 "Vibe-Coding" is the most distinctive title
