...
### Depth Mismatches
- APE (Section 10.3, subsection 5.1) receives only one paragraph. Either expand or merge into OPRO comparison. (TIER 3)
...
### Issues
1. **Duplicate figure number:** Figure 10.4 is used twice in section-10.2.html. The ToT branching diagram (line 465) and the decision flowchart (line 785) are both labeled "Figure 10.4". The flowchart should be Figure 10.4b or renumbered to Figure 10.10. Priority: HIGH (TIER 1)
...
- 10.4 references Section 11.4 for cost optimization.
...
2. **10.4, structured output:** Should add "For implementation details on Instructor and Pydantic, see Section 9.2." (TIER 2)
...
4. **Add cross-reference to Section 9.2 in 10.4** for structured output: Reduces redundancy. Priority: HIGH (TIER 2)
...
| # | File | Issue | Agent(s) |
|---|------|-------|----------|
| 1 | section-10.2.html | Figure 10.3: Direct Prompting shows answer "436" labeled "INCORRECT" but 436 is the correct answer. Fix the diagram to show an actual error or correct the label. | 04, 10, 11, 17 |
| 2 | section-10.2.html | Duplicate Figure 10.4 number: ToT diagram and decision flowchart share the same figure number. Renumber the flowchart. | 09, 17 |

### TIER 2 (Should Fix)
| # | File | Issue | Agent(s) |
|---|------|-------|----------|
| 3 | section-10.2.html | Add forward reference to Module 21 from ReAct section | 13 |
| 4 | section-10.4.html | Add cross-reference to Section 9.2 for structured output | 01, 13 |
| 5 | section-10.1.html | Add brief context window note referencing Module 04 | 01, 13, 21 |
| 6 | section-10.3.html | Define or comment `run_tests()` stub in Reflexion code | 08 |
| 7 | section-10.2.html | Define or comment `execute_search()` stub in ReAct code | 08 |
| 8 | section-10.2.html | Qualify "emergent abilities" claim with note on ongoing debate | 02, 10, 11 |
| 9 | section-10.3.html | Expand DSPy/PyTorch analogy | 02 |
| 10 | section-10.3.html | Add Constitutional AI self-check code snippet | 01 |
| 11 | section-10.4.html | Define "perplexity" on first use in LLMLingua section | 33 |
| 12 | section-10.4.html | Mention provider-level instruction hierarchy defenses | 01 |
| 13 | section-10.4.html | Note prompt injection detection as a separate classification step | 01 |

### TIER 3 (Nice to Have)
| # | File | Issue | Agent(s) |
|---|------|-------|----------|
| 14 | section-10.3.html | Expand APE section or merge into OPRO comparison | 01, 02 |
| 15 | section-10.2.html | Add transition between step-back and ReAct | 03, 14 |
| 16 | section-10.1.html | Mention Jinja2 as alternative to f-string templates | 01 |
| 17 | section-10.3.html | Add "What Just Happened" summary between reflection and meta-prompting | 05 |
| 18 | section-10.2.html | Note reasoning models earlier when CoT is first introduced | 04 |
| 19 | section-10.1.html | Address "What if few-shot examples are mislabeled?" | 04 |
| 20 | section-10.4.html | Mention prompt caching as cost optimization | 27 |
| 21 | section-10.3.html | Add DSPy version note (already present, Agent 01 satisfied) | 01 |
| 22 | All sections | Add coding exercises beyond quiz questions | 07 |
| 23 | section-10.2.html | A/B comparison demo (with vs. without CoT) | 28 |
