...
**Method:** Static analysis of decompose/extract/unwrap/filter calls across `KDP/build/` and `KDP/html2epub/src/`, plus element-count comparison source HTML vs built EPUB.
...
- **Loc:** `KDP/html2epub/src/html2epub/builder.py:185`
...
- **Loc:** `KDP/html2epub/src/html2epub/content.py:slim_index_lists`
...
- **Loc:** `KDP/build/_html2epub_hooks.py:simplify_inline_mathml` (v802)
...
- **Loc:** `KDP/build/_html2epub_hooks.py:strip_wide_table_notes` (v13.6)
- **Reason:** html2epub library injects a prose note before wide tables ("Wide Table (N columns) — On narrow screens..."). The note added noise to the EPUB without value.
- **Content impact:** 40 prose notes removed across 24 chapters. Tables themselves preserved.

### 7. Wisdom-council slim
- **Loc:** `KDP/build/_html2epub_hooks.py:slim_wisdom_council`
...
- **Loc:** `KDP/build/_html2epub_hooks.py:fix_math_alignment`
...
- **Loc:** `KDP/html2epub/src/html2epub/content.py:65-67`
...
- **Loc:** `KDP/html2epub/src/html2epub/content.py:UNWANTED_TAGS`
...
- **Loc:** `KDP/html2epub/src/html2epub/content.py:60-62`
...
- **Loc:** `KDP/html2epub/src/html2epub/builder.py:197`
...
## Explicit drop configuration (html2epub.toml)
