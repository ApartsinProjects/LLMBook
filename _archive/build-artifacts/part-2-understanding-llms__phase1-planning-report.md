...
**1. [Module 08, Section 10.3] No from-scratch speculative decoding implementation.**
...
**2. [Module 08, Section 10.3] Mathematical proof of distribution preservation is missing.**
...
**6. [Module 08, Section 10.2] GQA memory savings not demonstrated numerically.**
...
**9. [Module 08, Section 10.1] GGUF format not discussed.**
GGUF is the dominant quantization format for local inference (llama.cpp, Ollama), which Section 10.4 extensively covers. Students using Ollama in Section 10.4 will encounter GGUF models immediately. Section 10.1 should explain GGUF's mixed-precision approach (different bit widths for attention vs. feed-forward layers).

**10. [Module 08, Section 10.2] TTT (Test-Time Training) explanation is too brief.**
...
**16. [Module 08, Section 10.4] TensorRT-LLM has no code example.**
...
**17. [Module 08, Section 10.1] GPTQ Hessian explanation is insufficient.**
...
**21. [Module 08, Section 10.2] H2O eviction policy mentioned but not explained.**
...
Section 10.2 discusses GQA and MLA, which are also covered in Section 7.2 (DeepSeek V3 deep dive). The overlap is intentional (architecture in 7.2, memory optimization in 8.2) but should be explicitly acknowledged with a cross-reference callout to avoid student confusion.
...
**29. [Module 08, Section 10.4] Cost optimization and auto-scaling not covered.**
...
**30. [Module 08, Section 10.4] Apple Silicon / MLX inference absent.**
